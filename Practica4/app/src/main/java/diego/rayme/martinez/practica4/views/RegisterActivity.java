...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (email.isEmpty() || tipo.isEmpty() || motivo.isEmpty()) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(email, tipo, motivo);
        } else {
            ...
            call = service.createSolicitudWithImage(emailPart, tipoPart, motivoPart, imagenPart);
        }
